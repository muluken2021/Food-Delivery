    ...
    <div className='mx-6 md:mx-24 my-20 grid grid-cols-1 lg:grid-cols-2 gap-8'>
      ...
      <div className='w-full'>
        ...
        <button
          ...
          disabled={loading}
          className='w-full mt-6 border-2 border-brand-400 rounded py-2 px-4 uppercase cursor-pointer text-white bg-brand-400 hover:bg-brand-300 transition duration-300'
        >
